...
SQLite and uploaded market-data files are intentionally ignored by Git. They are runtime data, not source code. The application can recreate the database schema automatically on startup.
